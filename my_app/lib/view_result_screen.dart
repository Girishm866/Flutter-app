        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final result = match.data().toString().contains('result')
                  ? match['result']
                  : 'Result not uploaded';
...
// Example: How to navigate to this screen (use this from any other screen)
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (_) => ViewResultScreen()));
          },
